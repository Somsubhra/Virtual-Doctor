...
<link rel="stylesheet" href="code/menu_style.css" /><link rel="stylesheet" href="code/style.css" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>VDoc+: Medical history</title>
</head>
...
<h1>Medical History</h1><hr /><p>
<?php
$id = $_SESSION['SESS_MEMBER_ID'];
$conn = mysql_connect("localhost","root","");
mysql_select_db("vdocdatabase",$conn);
$query = "select medical_history from userinfo where member_id='$id'";
$execute=mysql_query($query);

$result = mysql_fetch_array($execute);
echo($result['medical_history']);
