...
<title>VDoc+: Lung Diseases- Bronchitis</title>
</head>
...
<h1>Lung Diseases: Bronchitis</h1><hr>
<p>
Bronchitis is inflammation of the mucous membranes of the bronchi, the airways that carry airflow from the trachea into the lungs. Bronchitis can be divided into two categories, acute and chronic, each of which has distinct etiologies, pathologies, and therapies.<br />

Acute bronchitis is characterized by the development of a cough, with or without the production of sputum, mucus that is expectorated (coughed up) from the respiratory tract. Acute bronchitis often occurs during the course of an acute viral illness such as the common cold or influenza. Viruses cause about 90% of cases of acute bronchitis, whereas bacteria account for fewer than 10%.<br />
...
<img src="images/understanding_bronchitis_basics_bronchitis.jpg"  hspace="300"/>
</body>
