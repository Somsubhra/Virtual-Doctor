...
<title>VDoc+: First-Aid:Burns</title>
</head>
...
<br />
4. Seek emergency treatment immediately for major burns.
<br />


5. Do not place any creams, ointments or ice on the burned area or break blisters.
<br />
6. Remove the person from the source of the burn (fire, electrical current, etc.).
<br />
7. If the person is not breathing, begin mouth-to-mouth resuscitation immediately

(see Mouth-to-Mouth Resuscitation).
<br />
8. Remove all smoldering clothing to stop further burning.
<br />
9. If the person is breathing sufficiently, cover the burned area with a cool, moist, sterile bandage or clean cloth. 
</p>
</body>
</html>
